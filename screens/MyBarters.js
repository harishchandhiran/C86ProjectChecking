  ...
  static navigationOptions = { header: null };
   ...
   renderItem = ( {item, i} ) =>(
     <ListItem
       ...
       rightElement={
           <TouchableOpacity style={styles.button} onPress={() => { this.sendNotification(item)  }}>
   ...
   sendNotification = (bookDetails) => {
     db.collection("all_notifications").add({
      "targeted_user_id": bookDetails.receiver_id,
      "donor_id": this.state.userId,
      "request_id": bookDetails.request_id,
      "item_name": bookDetails.object_name,
      "date": firebase.firestore.FieldValue.serverTimestamp(),
      "message": this.state.userId + " has sent you",
